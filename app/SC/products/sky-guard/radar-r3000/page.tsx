...
export default function RadarR3000PageSC() {
  return (
    <div>
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">Sky-Guard 雷达 R3000</h1>
          <p className="text-xl text-[#f0b429] font-medium mb-8">3公里低空无人机探测雷达</p>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-400 leading-relaxed">
              Sky-Guard 雷达 R3000 是一款紧凑型全相参Ku波段脉冲多普勒雷达，专为低空无人机探测与跟踪而设计。系统由雷达主机、电动转台和显控终端软件组成，实时输出三维目标数据——距离、方位、高度、速度、经纬度，并可为同址光电（EO）系统或反无人机效应器提供精确引导。
            </p>

            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">工作模式</h2>
            <p className="text-zinc-400 leading-relaxed">
              <strong className="text-zinc-300">360°全域低空监视：</strong>雷达在终端软件控制下连续360°方位机械扫描，同时电子扫描0°–30°俯仰角，自动起始航迹、保持关联并向显控台报告结果。
            </p>

            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">应用场景</h2>
            <ul className="text-zinc-400 space-y-2">
              <li><strong className="text-zinc-300">独立部署：</strong>架设于三脚架，独立完成无人机探测与跟踪。</li>
              <li><strong className="text-zinc-300">系统集成：</strong>联接光电识别、干扰或欺骗子系统，构成完整的探测-跟踪-处置能力。</li>
              <li><strong className="text-zinc-300">车载/固定站：</strong>安装于车顶作为移动监测站，或安装于建筑物顶作为永久监视点。</li>
            </ul>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <tbody className="text-zinc-300">
                  ...
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">峰值发射功率</td><td className="py-3">≤ 20 W</td></tr>
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">最大探测距离</td><td className="py-3">≥ 3 km（DJI Phantom 3/4, Pd = 85%）</td></tr>
                  ...
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">功耗</td><td className="py-3">≤ 150 W（含转台）</td></tr>
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">系统重量</td><td className="py-3">≤ 30 kg（雷达+转台）</td></tr>
            ...
            <div className="mt-12 rounded-xl border border-[#f0b429]/30 bg-[#f0b429]/5 p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <a href="/downloads/Sky-Guard_Radar_R3000_Datasheet.pdf" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-[#f0b429] text-black font-semibold hover:bg-[#e6a800] transition-colors whitespace-nowrap" download>下载 PDF</a>
            </div>
          </div>
        </div>
      </section>

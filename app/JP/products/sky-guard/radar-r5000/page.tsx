...
export default function RadarR5000PageJP() {
  return (
    <div>
      <section className="py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">Sky-Guard レーダー R5000</h1>
          <p className="text-xl text-[#f0b429] font-medium mb-8">5 km 低高度UAV検出レーダー</p>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-400 leading-relaxed">
              Sky-Guard レーダー R5000は、Sky-Guardレーダーファミリーの拡張距離型です。R3000と同じKuバンド全コヒーレントパルスドップラーアーキテクチャを共有し、より高い送信電力により消費者向け小型UAVに対し最大5 kmの検出距離を実現します。レーダーユニット、電動ターンテーブル、表示制御端末ソフトウェアで構成され、広域ペリメーターセキュリティおよび重要インフラ防護向けのリアルタイム3Dターゲットデータを提供します。
            </p>

            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">動作モード</h2>
            <p className="text-zinc-400 leading-relaxed">
              <strong className="text-zinc-300">360°全方位低高度監視：</strong>レーダーは連続360°方位角機械走査を行いながら、仰角0°〜30°を電子走査します。ターゲットは自動的に検出・追跡され、リアルタイムで表示コンソールに報告されます。
            </p>

            <h2 className="text-2xl font-semibold text-white mt-12 mb-4">アプリケーション</h2>
            <ul className="text-zinc-400 space-y-2">
              <li><strong className="text-zinc-300">スタンドアロン展開：</strong>三脚に設置し、独立した広域UAV監視を実施。</li>
              <li><strong className="text-zinc-300">システム統合：</strong>電子光学識別、ジャミング、スプーフィングサブシステムと連携し、完全な検出-追跡-無力化チェーンを構築。</li>
              <li><strong className="text-zinc-300">車載/固定局：</strong>車載で迅速展開、または屋上設置で常設ペリメーターモニタリング。</li>
            </ul>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <tbody className="text-zinc-300">
                  ...
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">ピーク送信電力</td><td className="py-3">≤ 100 W</td></tr>
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">最大検出距離</td><td className="py-3">≥ 5 km（DJI Phantom 3/4, Pd = 85%）</td></tr>
                  ...
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">消費電力</td><td className="py-3">≤ 200 W（ターンテーブル含む）</td></tr>
                  <tr className="border-b border-white/10"><td className="py-3 pr-4 text-zinc-400">システム重量</td><td className="py-3">≤ 35 kg（レーダー+ターンテーブル+三脚）</td></tr>
            ...
            <div className="mt-12 rounded-xl border border-[#f0b429]/30 bg-[#f0b429]/5 p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <a href="/downloads/Sky-Guard_Radar_R5000_Datasheet.pdf" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-[#f0b429] text-black font-semibold hover:bg-[#e6a800] transition-colors whitespace-nowrap" download>PDF ダウンロード</a>
            </div>
          </div>
        </div>
      </section>
